...
import net.mtheninja615.codex_of_champions.entities.armor.MonstrosityArmorModel;
import net.neoforged.api.distmarker.Dist;
import net.neoforged.api.distmarker.OnlyIn;
import software.bernie.geckolib.renderer.GeoArmorRenderer;

public class MonstrosityArmorItem extends ImbuableModArmorItem {
    public MonstrosityArmorItem(Type type, Properties settings) {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new MonstrosityArmorModel());
    }
}
