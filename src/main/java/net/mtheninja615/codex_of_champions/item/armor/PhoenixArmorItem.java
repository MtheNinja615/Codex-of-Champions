...
import net.mtheninja615.codex_of_champions.entities.armor.PhoenixArmorModel;
import net.neoforged.api.distmarker.Dist;
import net.neoforged.api.distmarker.OnlyIn;
import software.bernie.geckolib.renderer.GeoArmorRenderer;

public class PhoenixArmorItem extends ImbuableModArmorItem {
    public PhoenixArmorItem(Type type, Properties settings) {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new PhoenixArmorModel());
    }
}
