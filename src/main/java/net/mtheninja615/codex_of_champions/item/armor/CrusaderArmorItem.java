...
import net.mtheninja615.codex_of_champions.entities.armor.CrusaderArmorModel;
import net.mtheninja615.codex_of_champions.entities.armor.LightningHeraldArmorModel;
import net.neoforged.api.distmarker.Dist;
import net.neoforged.api.distmarker.OnlyIn;
import software.bernie.geckolib.renderer.GeoArmorRenderer;

public class CrusaderArmorItem extends ImbuableModArmorItem {
    public CrusaderArmorItem(Type type, Properties settings) {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new CrusaderArmorModel());
    }
}
