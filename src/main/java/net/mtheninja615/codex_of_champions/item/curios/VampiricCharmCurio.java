...
public class VampiricCharmCurio extends CurioBaseItem {
    ...
    public Multimap<Holder<Attribute>, AttributeModifier> getAttributeModifiers(SlotContext slotContext, ResourceLocation id, ItemStack stack) {
        ...
        attr.put(AttributeRegistry.BLOOD_SPELL_POWER, new AttributeModifier(id, 0.20, AttributeModifier.Operation.ADD_MULTIPLIED_BASE));
        attr.put(ALObjects.Attributes.LIFE_STEAL, new AttributeModifier(id, 0.1, AttributeModifier.Operation.ADD_VALUE));
        return attr;
    }
}
